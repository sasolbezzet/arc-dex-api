...
export function createMcpServer(userId, context = {}) {
  ...
  // ── TOOL EXTENSIONS (focused modules under src/services/mcp/) ──
  const toolCtx = {
    registerTool, jsonText, mscaRequiredResult, z, getAddress,
    resolveMsca: () => resolveActiveMsca(userId, boundMscaWalletAddress),
    apiGet: (path, owner) => apiGet(path, owner),
